...
urlpatterns = [
    ...
    path("events/<uuid:id>/revisions", EventRevisionListCreateView.as_view(), name="event-revision-list"),
    path("events/<uuid:id>/revisions/<uuid:revision_id>", EventRevisionDetailView.as_view(), name="event-revision-detail"),
